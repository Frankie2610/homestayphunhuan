# Chatbot website Homestay Phú Nhuận
...
Widget nhận phản hồi bằng streaming: câu trả lời được hiển thị ngay sau khi lõi hội thoại và Gemini tạo xong, không chờ log tin nhắn ghi xong. Trạng thái hội thoại, lịch trống và giá vẫn đọc/lưu bằng Firebase; các log không quyết định câu trả lời được chuyển sang tác vụ nền của Vercel. API có ngưỡng dự phòng 18 giây và trình duyệt chờ tối đa 25 giây.
